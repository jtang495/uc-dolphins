      ...
      <div class="row-fluid">
        ...
        <div class="span5">
          ...
          <h3>Pot Luck & Pep Rally <span class="label label-warning">NEW</span></h3>
            ...
            <a class="btn btn-info" href="pdf/family-potluck-info.pdf" target="_blank">More Details <i class="icon-arrow-right icon-white"></i></a>
            <a class="btn btn-primary" href="http://www.signupgenius.com/go/10C0D4DABA62B0-social2" target="_blank">Volunteer Sign-up <i class="icon-pencil icon-white"></i></a>
          <hr class="featurette-divider">
