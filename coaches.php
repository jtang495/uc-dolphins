         ...
         <div class="container">
            <div class="marketing">
                  ...
                  <div class="featurette">
                     <img class="featurette-image pull-left" src="img/jen-taylor.jpg">
                  ...
                  <div class="featurette">
                     <img class="featurette-image pull-right" src="img/shannon-king.jpg">
                     <h2 class="featurette-heading">Shannon King. <span class="muted">Assistant Coach.</span></h2>
                     <p class="lead">
                     Shannon started swimming for Upper County when she was 10 years old and continued to be a Dolphin until she graduated from GHS.  Shannon has been teaching swimming lessons for 9 years.  During the winter she is the head coach for the Gaithersburg High School winter swim team.

                     Shannon is now a graduate from the University of Maryland and working full time so we are happy to have her back on the team!
                     </p>
                  </div>
                  <hr class="featurette-divider">
                  <!-- /END THE FEATURETTES -->
