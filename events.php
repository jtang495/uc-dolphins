  ...
  <div class="container">
    <div class="marketing">
      ...
      <div class="featurette">
        ...
        <p class="lead">
          <strong>Date:</strong> Monday, July 15</br>
          <strong>Where:</strong> Six Flags America
      </div>
      <hr class="featurette-divider">
      <div class="featurette">
        <div class="featurette-video pull-left">
      ...
      <hr class="featurette-divider">
      <div class="featurette">
        <img class="featurette-image img-polaroid pull-right" src="img/thumb-pajama-night.jpg" style="width: 40%;">
